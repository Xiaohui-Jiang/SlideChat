...
def _cell_typing_step() -> PlanStep:
    return PlanStep(
        ...
        param_prompts=[
            ...
            ParameterPrompt(
                name="marker_sets",
                prompt=PARAMETER_PROMPTS["cell_typing"]["marker_sets"],
                type=str,
                optional=True,
            ),
            ParameterPrompt(
            ...
            ParameterPrompt(
                name="expected_types",
                prompt=PARAMETER_PROMPTS["cell_typing"]["expected_types"],
                type=str,
                optional=True,
                context_key="expected_cell_types",
            ),
            ParameterPrompt(
                name="question",
            ...
            ParameterPrompt(
                name="method",
                prompt=PARAMETER_PROMPTS["cell_typing"]["method"],
                type=str,
                default="scanpy",
                choices=["scanpy", "celltypist", "automated"],
            ),
            ParameterPrompt(
                name="output_key",
